...
// Constructeur qui initialise et affiche le menu principal
MazeWindow::MazeWindow() {
	...
	m_label.set_markup("<span size='large'>\n\t\t\t\tComment jouer ? \n\n\t\t\t\t - Allé vers le haut : 'z' \n\t\t\t\t - Allé vers le bas : 's' \n\t\t\t\t - Allé vers la gauche : 'q' \n\t\t\t\t - Allé vers la droite : 'd' \n\n\t\t\t\t Code triche (solution) : 't'\n\n\n<span size='medium'> Info :Plus la difficulté du labyrinthe est élevé, plus le score l'est aussi ! </span></span>");
	m_label.set_hexpand(true);
	m_grid.attach(m_label, 0, 5, 2, 1);

	// Permet les interruptions liés aux touches 
